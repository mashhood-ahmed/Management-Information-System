<?php 
	...
	$record = $pr->getProfile($_SESSION['id']);
...
<div id="cross">
 ...
 <form action="" method="post">
 	...
 	<div class="form-group">
 		...
 		<input type="text" required class="form-control" name="user" id="user" value="<?php echo $row['username']; ?>" />
 	</div>

 		<div class="form-group">
		<label for="fname">First Name:</label>
		<input type="text" required name="fname" id="fname" class="form-control" value="<?php echo $row['fname']; ?>" /> 
 	</div>

 	<div class="form-group">
		<label for="lname">Last Name:</label>
		<input type="text" required name="lname" id="lname" class="form-control" value="<?php echo $row['lname']; ?>" /> 
 	</div>

 	<div class="form-group">
 		<label for="ema">Email:</label>
 		<input type="email" required class="form-control" name="ema" id="ema" value="<?php echo $row['email']; ?>" />
 	</div>

 	<div class="form-group">
		<label for="old">Current Password:</label>
		<input type="text" disabled name="old" id="old" class="form-control" value="<?php echo $row['pass']; ?>" /> 
 	</div>
...
class profile {
	...
	if(isset($_POST['pro'])) {
		...
		if($npass == null && $cpass == null) {
			...
			$res = $pr->updateProfile($profile,$_SESSION['id']);
