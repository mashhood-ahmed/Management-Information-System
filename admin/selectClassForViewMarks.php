<?php 
	...
	$new_record = $acm->getAssignCourses();
 ?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<form action="" method="get">
		...
		<div class="form-group">
			...
			<select name="cou" class="form-control" id="sub" required onchange="getSemesterByCouse(this.value)">
		...
		<input type="submit" name="abtn" value="Next" class="btn btn-success" />
