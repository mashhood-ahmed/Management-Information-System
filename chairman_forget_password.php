	...
	<div id="main-box" class="container-fluid">
		...
		<?php
		 ...
		 <section class="row sec">
			...
			<center>
				<input type="submit" name="chairForget" value="Next" class="btn btn-success" />
			</center>
...
if(isset($_POST['chairForget'])) {

	$user = $_POST['user'];

	$query = "SELECT * FROM `chairman` WHERE username='$user'";
